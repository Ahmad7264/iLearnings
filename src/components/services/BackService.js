...
const BackService = ({ title }) => {
  const location = useLocation();
  return (
    <>
      <section className=" text-center max-md:bg-right max-md:p-[50%] max-md:h-[80vh] bg-service-i bg-cover absolute bg-fixed top-0 left-0 -z-10 w-full h-screen pt-72 pr-12 text-white overflow-hidden">
